                ...
                <div class="card group hover:shadow-md transition-shadow {{ session('current_store_id') == $store->id ? 'ring-2 ring-indigo-500' : '' }}">
                    <div class="card-body">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                                    <a href="{{ route('stores.show', $store) }}" class="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">
                                        {{ $store->name }}
                                    </a>
                                </h3>
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('stores.show', $store) }}" class="btn btn-ghost" title="Detail Toko">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                            </a>
                            <a href="{{ route('stores.edit', $store) }}" class="btn btn-ghost" title="Edit Toko">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
